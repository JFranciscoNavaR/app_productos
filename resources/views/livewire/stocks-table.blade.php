                ...
                <div class="flex-1 p-4">
                    <div class="flex items-center">
                        ...
                        <div class="flex ml-48 mr-2">
                            <a href="{{route('stock.new')}}" class="text-white hover:text-black">
                                            ...
                                            @foreach ($stocks as $stock)      
                                                <tr class="divide-x divide-gray-200">
                                                    ...
                                                    <td class="w-1/12 px-6 py-3 text-center whitespace-nowrap">
                                                        <a href="{{route('inventories.show', $stock->id)}}" class="text-white hover:text-black">
                                                    ...
                                                    <td class="w-1/12 px-6 py-3 text-center whitespace-nowrap">
                                                        <a href="{{route('stock.edit', $stock->id)}}" class="text-white hover:text-black">
                                                            <div class="hidden sm:block">
                                                    ...
                                                    <td class="w-1/12 px-6 py-4 whitespace-nowrap">
                                                        <a href="{{route('stock.delete', $stock->id)}}" class="text-white hover:text-black">
                                                            <div class="hidden sm:block" >
